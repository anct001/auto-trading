...
# (method, path) routing table is expressed directly in handle_request for clarity.
_READ_ONLY_PATHS = frozenset({"/api/dashboard"})
...
def serve(ctx: OperatorContext, *, host: str = "127.0.0.1", port: int = 8787) -> None:
    ...
    class _Handler(BaseHTTPRequestHandler):
        def _dispatch(self, method: str) -> None:
            ...
            out = json.dumps(resp.body).encode("utf-8")
